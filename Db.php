...
include 'connection.php';
	class Db{
	static public function user_login($email, $pass)
	{	
	...
	static public function reg_user($reg_rec)
	{
	...
	static public function user_rec($id)
	{
		$query = mysqli_query($GLOBALS['con'],"select * from users where uid= '".$id."' ");
		return $query;
	}
	static public function upload_img($img_name,$img_tmp, $uid)
	{
	...
	static public function rec_4_update($uid)
	{
		$query = mysqli_query($GLOBALS['con'],"select * from users where uid= '".$uid."' ");
		return $query;
	}
	static public function update_user_rec($user_rec_4_update)
	{
	...
	static public function city($province)
	{
		$query ="select * from cities where province = '".$province."' ";
		return mysqli_query($GLOBALS['con'],$query);
	}
	static public function post_job($job_rec)
	{
	...
	static public function all_jobs()
	{
		$query = "SELECT * FROM jobs";
		return mysqli_query($GLOBALS['con'],$query);
	}
	static public function user_posted_jobs($pid)
	{
		$query = "SELECT * FROM jobs where pid = '".$pid."' ";
		return mysqli_query($GLOBALS['con'],$query);
	}
	static public function edit_job($id)
	{
		$query = "SELECT * from jobs where id = '".$id."' ";
		return mysqli_query($GLOBALS['con'],$query);
	}
	static public function update_job($job_update_rec)
	{
	...
	static public function apply_4_job($apply_rec)
	{
	...
	static public function add_category($value)
	{
	...
	static public function admin_rec($id)
	{
		$query = "SELECT * FROM admin where id = '".$id."' ";
		return mysqli_query($GLOBALS['con'],$query);
	}
	static public function change_ad_username($name,$id)
	{
		$query = "UPDATE admin set email = '".$name."' where id = '".$id."' ";
		return mysqli_query($GLOBALS['con'],$query);
	}
	static public function change_ad_pass($new_pass,$id)
	{
